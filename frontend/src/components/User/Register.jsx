...
const Register = () => {
  ...
  const [time, setTime] = useState('');  // Changed from `settime` to `setTime` for better clarity
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      console.log("Timeslot value:", time);  // Debugging
      const response = await Axios.post(`${import.meta.env.VITE_BACKEND_URL}user/register`, {
        ...
        email: email,
        password: password,
        timeslot: time,  // Ensure this value is set correctly
      });
        ...
        <div className='w-full'>
          <div className="grid md:grid-cols-2 md:gap-6">
            ...
            <div className="relative z-0 w-full mb-5 group">
              ...
              >
                <i className="fas fa-user mr-2"></i> {/* Example FontAwesome icon */}
                Last name
              </label>
          ...
          <div className="relative z-0 w-full mb-5 group">
            ...
            <label
              ...
              className="peer-focus:font-medium absolute text-sm text-gray-700 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 flex items-center"
            >
              <i className="fas fa-envelope mr-2"></i> {/* Example FontAwesome email icon */}
              Email address
            </label>
          ...
          <div className="relative z-0 w-full mb-5 group">
            ...
            <label
              ...
              className="peer-focus:font-medium absolute text-sm text-gray-700 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 flex items-center"
            >
              <i className="fas fa-lock mr-2"></i> {/* Example FontAwesome lock icon for password */}
              Password
            </label>
          ...
          <div className="relative z-0 w-full mb-5 group">
           ...
           <label
              ...
              className="peer-focus:font-medium absolute text-sm text-gray-700 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 flex items-center"
            >
              <i className="fas fa-lock mr-2"></i> {/* Example FontAwesome lock icon */}
              Confirm password
            </label>
          ...
          <div className="relative z-0 w-full mb-5 group">
            ...
            <label
              ...
              className="peer-focus:font-medium absolute text-sm text-gray-700 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 flex items-center"
            >
              <i className="fas fa-user mr-2"></i> {/* Example FontAwesome user icon */}
              Bio
            </label>
          ...
          <div className="relative z-0 w-full mb-5 group">
          <textarea
            placeholder="Add atleat 5 time slot in this form (Eg:8am-9am,9am-10am) "
            value={time}
